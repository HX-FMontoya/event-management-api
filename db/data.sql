...
(1, '$2b$10$bPzvIJObpFR0gkfVyG2vsO/QIAZI/mEEfG5QrKkKo.QNdjsqxUbdm', NULL, '2024-09-10 12:34:56'),
(2, '$2b$10$bPzvIJObpFR0gkfVyG2vsO/QIAZI/mEEfG5QrKkKo.QNdjsqxUbdm', 'reset_token_value', '2024-09-11 09:15:32'),
(3, '$2b$10$bPzvIJObpFR0gkfVyG2vsO/QIAZI/mEEfG5QrKkKo.QNdjsqxUbdm', NULL, '2024-09-12 14:21:10');
...
(2, 2, 'Feria de Emprendimiento Quito 2024', 'Evento de networking para emprendedores y startups de Ecuador.', '2024-11-15 10:00', '2024-11-19 16:00', 'scheduled', 'https://www.quitoinforma.gob.ec/wp-content/uploads/2023/11/Ferias-de-Emprendimiento-1-800x445.jpeg'),
(1, 3, 'Concierto de Rock en CDMX', 'Tres días de rock con las mejores bandas latinoamericanas.', '2024-12-05 20:00', '2024-12-07 23:59', 'scheduled', 'https://elalebrije.net/wp-content/uploads/2023/02/img_5285.jpg?w=873');

INSERT INTO tickets (event_id, user_id, ticket_type, price, purchase_date, status, enabled_days) VALUES
(1, 2, 'General', 150.00, '2024-09-12 10:00', 'paid', '{"tuesday"}'),
(2, 3, 'VIP', 250.00, '2024-09-13 11:30', 'reserved', '{"friday","saturday","sunday","monday","tuesday"}'),
(3, 1, 'General', 100.00, '2024-09-14 14:00', 'paid', '{"thursday","friday","saturday"}');
